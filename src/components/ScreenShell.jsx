 ...
 */
export default function ScreenShell({ title, subtitle, step, total, onBack, children, cta, ctaDisabled, onCta, ctaColor = 'brand' }) {
  ...
  return (
    <div className="phone-shell flex flex-col" style={{ minHeight: '100dvh' }}>
      ...
      {/* Footer CTA */}
      {cta && (
        <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[420px] bg-white border-t border-slate-100 p-4 z-30">
          <button
            onClick={onCta}
